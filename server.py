...
class Router:
    ...
    def add_patch(self, function, url: str, meta: dict = None):
        ...
        self.swagger_generator(method_type="PATCH", metadata=meta, url=rel_url, table=table)
    ...
    def run(self):
        try:
            ...
            if self.__SHOW_URLS:
                ...
                for g in self.__METHODS.post_methods.keys():
                    print("http://" + self.__HOST + ":" + str(self.__PORT) + "/" + g)
                for g in self.__METHODS.put_methods.keys():
                    print("http://" + self.__HOST + ":" + str(self.__PORT) + "/" + g)
                for g in self.__METHODS.delete_methods.keys():
                    print("http://" + self.__HOST + ":" + str(self.__PORT) + "/" + g)
                for g in self.__METHODS.patch_methods.keys():
                    print("http://" + self.__HOST + ":" + str(self.__PORT) + "/" + g)
